...
$("html,body").animate({ scrollTop: $(".tiao1").offset().top-$().height() }, 500); 
 })

 $(".tiao2").click(function(){
$("html,body").animate({ scrollTop: $("#wy1").offset().top-$().height() }, 500); 
 })


 $(".tiao3").click(function(){
$("html,body").animate({ scrollTop: $("#wy2").offset().top-$().height() }, 500); 
 })

 $(".tiao4").click(function(){
$("html,body").animate({ scrollTop: $("#wy3").offset().top-$().height() }, 500); 
 })

 $(".tiao5").click(function(){
$("html,body").animate({ scrollTop: $("#wy4").offset().top-$().height() }, 500); 
 })
